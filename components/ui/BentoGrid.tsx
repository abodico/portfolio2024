...
export const BentoGrid = ({
    ...
    return (
        <div
            className={cn(
                "grid md:auto-rows-[10rem] grid-cols-1 md:grid-cols-6 lg:grid-cols-5 md:grid-row-7 gap-4 lg:gap-8 mx-auto md:grid-row-7",
                className
            )}
        >
            {children}
...
export const BentoGridItem = ({
    ...
    const handleCopy = () => {
        navigator.clipboard.writeText("abomajedabbara@gmail.com")
        setCopied(true)
    }
    return (
        <div
        ...
        >
            <div
                className={`${
                    id === 6 && "flex justify-center md:flex-row flex-col"
                }  h-full`}
            >
                ...
                >
                    ...
                    {id === 3 && (
                        <div className="flex gap-1 lg:gap-5 w-fit absolute top-0 -right-3 lg:-right-2">
                            ...
                            <div className="flex flex-col gap-3 lg:gap-8">
                                <span className="py-4 px-3 rounded-lg text-center bg-[#10132e]" />
                                {["Redux", "MUI", "TailwindCSS"].map((item) => (
                                    <span
                                        key={item}
                                        className="py-2 lg:py-4 lg:px-3 px-3 text-xs lg:text-base opacity-50 lg:opacity-100 rounded-lg text-center bg-[#10132e]"
                                    >
